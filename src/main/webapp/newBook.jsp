  ...
  <html>
    ...
    <body>
      ...
      <div class="container-fluid cover-img">
        <div class="row">
          <div class="col-12">
            <h3 class="text-dark mt-2 mb-2 cover-img-text">New Book</h3>
          </div>
        </div>
      </div>
            ...
            <div class="card card-highlight m-0 p-0">
              ...
              <div class="card-body m-0 pt-0 pl-1 pr-1 pb-2">
                <div
                  ...
                  class="ml-2 mr-2"
                ></div>
                <div class="ml-2 mr-2">MRP - <span></span>/- Rs</div>
                <div style="display: flex">
                  <a
                    href="./viewBook.jsp?bookId"
                    target="_blank"
                    class="btn btn-outline-primary form-control ml-2 mr-1 btn-sm"
                    >View Item</a
                  >
                  <button
                    onclick="addCart()"
